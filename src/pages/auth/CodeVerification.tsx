            ...
            <Box sx={{ padding:"32px", borderRadius:"8px", width:"60%", backgroundColor:"#F9FAFB", height:"56vh"}}>
                <Box sx={{gap:"10px", marginY:'20px',  width:"100%", flexDirection:"column", display:"flex", alignItems:"center", justifyContent:"center"}}>
                  <img src={iconBlue} alt="iconBlue" />
                    ...
                    <Typography variant='body2' sx={{ width:"100%", alignSelf:"start", fontWeight:"400", fontSize:"14px", textAlign:"start" }}>Please enter the 6 digit code sent to example@abc.com</Typography>
                </Box>
              ...
              <form style={{ width:"100%", display:"flex", alignItems:"start", flexDirection:"column", gap:"10px" }}>
                   ...
                   <Box sx={{ marginY:"10px", width:"100%", display:"flex", alignItems:"center", justifyContent:'center', gap:"10px"}}>
                        ...
                        <TextField
                            ...
                            style: { height:"60px", textAlign: 'center', color:"#333", fontSize: '24px', padding: '8px'}}}
                            sx={{ width: '76px',}}
                        />
                        ))}
                  </Box>
            
                <Button type="submit" variant="contained" sx={{ marginTop:"20px", width:"100%", height:"50px",backgroundColor:"#1A56DB" , color:"#fff", borderRadius:"12px", fontWeight:"600", fontSize:"16px", textAlign:"center" }}>Verify code</Button>
